...
def extract_schedules(seasons: list = None) -> pl.DataFrame:
...
def extract_participation(seasons: list = None) -> pl.DataFrame:
...
def extract_charting(seasons: list = None) -> pl.DataFrame:
